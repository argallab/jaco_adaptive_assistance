...
def setFingerPositions(msg):
    global finger_value, currentFingerPosition, finger_maxTurn
    finger_value = [msg.axes[0]*300]3*
    # finger_value = [msg.twist_linear_x*300]*3
    # print finger_value
    finger_turn = [finger_value[i] + currentFingerPosition[i] for i in range(0, 3)]
...
if __name__ == '__main__':
    ...
    # kinova_robotTypeParser(args.robot_type)
    rospy.init_node('finger_teleop')
    rospy.Subscriber('/user_vel', PoseVelocity, setFingerPositions, queue_size=1)
